...
async def _(event):
    ...
    catevent = await edit_or_reply(
        event,
        "**᥀︙جاري اعاده تسميه الميديا قد يستغرب الأمر بضع دقائق اذا كان حجم الملف كبير.ً**",
    )
...
CMD_HELP.update(
    {
        ...
        \n\n  •  **• الأمر **`.إسم + الاسم الجديد`\
        \n  •  **• الشرح **__قم بالرد على الميـديا باستخدام الأمر أعلاه لإعادة تسمية وتحميل الملف بالاسم المحدد كــ ملف بنفس الصيغـه__\
        \n\n  •  **• الأمر **`.اسم + الاسم الجديد`\
        \n  •  **• الشرح **__قم بالرد على الميـديا باستخدام الأمر أعلاه لإعادة تسمية وتحميل الملف بالاسم المحدد كــ ملف __\
        "
    }
)

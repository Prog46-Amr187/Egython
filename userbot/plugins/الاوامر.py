...
########################  SOURCE Ralls ~ BY: Alsh (@RallsThon)  ########################
...
async def _(event):
    ...
    if input_str == "م1":
        ...
        if r == 0:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 Ralls𝙏𝙃𝙊𝙉 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/RallsThon) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒𝙏𝙃𝙊𝙉](t.me/RallsThon) 𓆪"
            )
        else:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 Ralls𝙏𝙃𝙊𝙉 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/RallsThon) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒𝙏𝙃𝙊𝙉](t.me/RallsThon) 𓆪"
...
########################  SOURCE Ralls𝙏𝙃𝙊𝙉 ~ BY: Alsh (@RallsThon)  ########################
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒 - 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](t.me/RallsThon) 🧸♥️𓆪\◐━─━─━─━─𝐑𝐀𝐈𝐈𝐒─━─━─━─━◐**\n 𓄂 الــريـــــس╺  𝑫𝑬𝑽 ╰──► @QQ070 ༗\n")
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/RallsThon) 🗑♻️𓆪\◐━─━─━─━─𝐑𝐀𝐈𝐈𝐒─━─━─━─━◐**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def dev(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @QQ070 ༗\n"
        cat_caption += f"◐━─━─━─━─𝐑𝐀𝐈𝐈𝐒─━─━─━─━◐"
        ...
        await edit_or_reply(
            ...
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @QQ070 ༗\n"
            f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧRallsⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻",
        )

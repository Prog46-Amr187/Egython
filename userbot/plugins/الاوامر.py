...
########################  SOURCE EGY ~ BY: Team Egython (@EgyThon)  ########################
...
async def _(event):
    ...
    if input_str == "م1":
        ...
        if r == 0:
            await event.edit(
                "𝐒𝐨𝐮𝐫𝐜𝐞 𝐄𝐠𝐲𝐭𝐡𝐨𝐧 - 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬.\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n **᥀︙قائـمه اوامر الادمن :** \n◄ `.حظر` \n◄ `.الغاء حظر` \n◄ `.تقيد` \n◄ `.الغاء تقيد` \n◄ `.رفع القيود` \n◄ `.كتم` \n◄ `.الغاء كتم` \n◄ `.تثبيت` \n◄ `.الغاء التثبيت` \n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻/n 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐒𝐨𝐮𝐫𝐜𝐞 - [𝐋𝐢𝐧𝐤](t.me/Egython) ."
            )
        else:
            await event.edit(
                "𝐒𝐨𝐮𝐫𝐜𝐞 𝐄𝐠𝐲𝐭𝐡𝐨𝐧 - 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬.\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n **᥀︙قائـمه اوامر الادمن :** \n◄ `.حظر` \n◄ `.الغاء حظر` \n◄ `.تقيد` \n◄ `.الغاء تقيد` \n◄ `.رفع القيود` \n◄ `.كتم` \n◄ `.الغاء كتم` \n◄ `.تثبيت` \n◄ `.الغاء التثبيت` \n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻/n𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐒𝐨𝐮𝐫𝐜𝐞 - [𝐋𝐢𝐧𝐤](t.me/Egython) ."
            )
...
########################  SOURCE EGYTHON ~ BY: Team Egython (@EgyThon)  ########################
...
########################  SOURCE EGY ~ BY: Team Egython (@JAI6H)  ########################
...
@bot.on(admin_cmd(pattern="رفع مراتي(?: |$)(.*)"))
@bot.on(sudo_cmd(pattern="رفع مراتي(?: |$)(.*)", allow_sudo=True))
async def permalink(mention):
    """ For .link command, generates a link to the user's PM with a custom text. """
    user, custom = await get_user_from_event(mention)
    if not user:
    ...
    if custom:
        await edit_or_reply(
            mention,
            f"᥀︙المستخدم [{custom}](tg://user?id={user.id}) \n ᥀︙تم رفعها مراتك بنجاح طيرو ع الخاص بقا 😉.",
        )
    else:
        tag = (
            user.first_name.replace("\u2060", "") if user.first_name else user.username

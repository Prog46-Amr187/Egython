...
########################  SOURCE RALLS   ~ BY: 𖠧 ๏͈͈͈͈͈͈͈𝐑𝐀𝐈𝐈𝐒 𖤓̟̟̟̟̟̟̥̥̥̥̟͜͡  (@Rallsthon)  ########################
...
async def _(event):
    ...
    if input_str == "م1":
        ...
        if r == 0:
            await event.edit(
                "𓆰 [𝙎𝙊𝙐𝙍𝘾 𝐑𝐀𝐈𝐈𝐒] - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/Rallsthon) 𓆪\n **⌔∮ قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾 𝐑𝐀𝐈𝐈𝐒𝙏𝙃𝙊𝙉](t.me/Rallsthon) 𓆪"
            )
        else:
            await event.edit(
                "𓆰 [𝙎𝙊𝙐𝙍𝘾 𝐑𝐀𝐈𝐈𝐒] - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/Rallsthon) 𓆪\n **⌔∮ قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾 𝐑𝐀𝐈𝐈𝐒𝙏𝙃𝙊𝙉](t.me/Rallsthon) 𓆪"
...
########################  SOURCE 𝐑𝐀𝐈𝐈𝐒𝙏𝙃𝙊𝙉 ~ BY: 𖠧 ๏͈͈͈͈͈͈͈𝐑𝐀𝐈𝐈𝐒 𖤓̟̟̟̟̟̟̥̥̥̥̟͜͡  (@Rallsthon)  ########################
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾 𝐑𝐀𝐈𝐈𝐒 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/Rallsthon) 𓆪\n **⌔∮ قائـمه اوامر الترحيب :** \n⪼ `.ترحيب ` \n⪼ `.حذف ترحيب ` \n⪼ `.الترحيب `\n 𓆩 [𝙎𝙊𝙐𝙍𝘾 𝐑𝐀𝐈𝐈𝐒](t.me/Rallsthon) 𓆪")
...
########################  SOURCE RALLS   ~ BY: 𖠧 ๏͈͈͈͈͈͈͈𝐑𝐀𝐈𝐈𝐒 𖤓̟̟̟̟̟̟̥̥̥̥̟͜͡  (@N7QQQ)  ########################
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾 𝐑𝐀𝐈𝐈𝐒 - 𝑩𝑳𝑨𝑪𝑲𝑳𝑰𝑺𝑻](t.me/Rallsthon) 𓆪\n **⌔∮ القائمة السوداء :** \n⪼ `.منع كلمه + الكلمه ` لمنع كلمه  \n⪼ `.الغاء منع + الكلمه` \n⪼ `.الكلمات المحظوره` \n⪼ `.ازعاج` \n⪼ `.الغاء ازعاج` \n⪼ `.قائمة الازعاج` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾 𝐑𝐀𝐈𝐈𝐒](t.me/Rallsthon) 𓆪")
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾 𝐑𝐀𝐈𝐈𝐒 - 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](t.me/Rallsthon) 🧸♥️𓆪\n**𓍹━─━─━─𝐑𝐀𝐈𝐈𝐒✪─━─━─━𓍻**\n **𓄂༒** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹  ↬ @N7QQQ ༗\n **𓄂༒** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹  ↬ @A_A7A ༗")
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾 𝐑𝐀𝐈𝐈𝐒 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/Rallsthon) 🗑♻️𓆪\n**𓍹━─━─━─𝐑𝐀𝐈𝐈𝐒✪─━─━─━𓍻**\n\n **✵│** رابـط الحـذف  ↬ https://telegram.org/deactivate ༗\n\n\n **✵│** بـوت الحـذف  ↬ @LC6BOT ༗")
...
CUSTOM_ALIVE_TEXT = "𓆩 𝙎𝙊𝙐𝙍𝘾 𝐑𝐀𝐈𝐈𝐒 - 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹 𓆪"
EMOJI = "  𓄂† "

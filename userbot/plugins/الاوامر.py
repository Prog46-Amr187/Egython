...
########################  SOURCE Ralls ~ BY: aloosh (@RallsThon)  ########################
...
########################  SOURCE 𝐑𝐀𝐈𝐈𝐒𝙏𝙃𝙊𝙉 ~ BY: aloosh (@RallsThon)  ########################
...
async def _(zed):
    await eor(zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/RallsThon) 𓆪\n **⌔∮ قائـمه اوامر الترحيب :** \n⪼ `.ترحيب ` \n⪼ `.حذف ترحيب ` \n⪼ `.الترحيب `\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒](t.me/RallsThon) 𓆪")
...
async def _(zed):
    await eor(zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒 - 𝑩𝑳𝑨𝑪𝑲𝑳𝑰𝑺𝑻](t.me/RallsThon) 𓆪\n **⌔∮ القائمة السوداء :** \n⪼ `.منع كلمه + الكلمه ` لمنع كلمه  \n⪼ `.الغاء منع + الكلمه` \n⪼ `.الكلمات المحظوره` \n⪼ `.ازعاج` \n⪼ `.الغاء ازعاج` \n⪼ `.قائمة الازعاج` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒](t.me/RallsThon) 𓆪")
...
async def _(zed):
    await eor(zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒 - 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](t.me/RallsThon) 🧸♥️𓆪\n**𓍹━─━─━─━─𝐑𝐀𝐈𝐈𝐒─━─━─━─━𓍻**\n **𓄂༒** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹  ↬ @QQ070 ༗\n **𓄂༒** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹  ↬ @VVVVX8 ༗\n **𓄂༒** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹  ↬ @U_F_N ༗")
...
async def _(zed):
    await eor(zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/RallsThon) 🗑♻️𓆪\n**𓍹━─━─━─━─𝐑𝐀𝐈𝐈𝐒─━─━─━─━𓍻**\n\n **✵│** رابـط الحـذف  ↬ https://telegram.org/deactivate ༗\n\n\n **✵│** بـوت الحـذف  ↬ @LC6BOT ༗")
...
DEFAULTUSER = "ZED"
CAT_IMG = "https://telegra.ph/file/be9f9a2283b1db8b2e3ae.jpg"
...
async def dev(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @VVVVX8 ༗\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 3 ↬ @U_F_N ༗\n"
        cat_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝐑𝐀𝐈𝐈𝐒ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
        ...
        await edit_or_reply(
            ...
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @VVVVX8 ༗\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 3 ↬ @U_F_N ༗\n"

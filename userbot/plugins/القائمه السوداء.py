# blacklist code for team egython by @Egython
    ...
    for snip in snips:
        ...
        if re.search(pattern, name, flags=re.IGNORECASE):
            try:
                ...
                await event.reply("**⌯︙انا لا املك صلاحية الحذف.!**")
...
async def on_add_black_list(event):
    ...
    await edit_or_reply(
        event,
        "**⌯︙تم منع الكلمه {} .**".format(len(to_blacklist)),
    )
...
async def on_delete_blacklist(event):
    ...
    await edit_or_reply(
        event,
        f"**⌯︙تم {successful} / {len(to_unblacklist)} الغاء منع الكلمه.**",
    )
...
async def on_view_blacklist(event):
    ...
    OUT_STR = "𝐄𝐠𝐲𝐭𝐡𝐨𝐧 - 𝐁𝐥𝐚𝐜𝐤 𝐋𝐢𝐜𝐭.\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**◄ قائمه الكلمات المحظوره :**\n"
    if len(all_blacklisted) > 0:
        for trigger in all_blacklisted:
            OUT_STR += f" » {trigger} .\n"
    else:
        OUT_STR = "𝐄𝐠𝐲𝐭𝐡𝐨𝐧 - 𝐁𝐥𝐚𝐜𝐤 𝐋𝐢𝐬𝐭.\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⌯︙لا توجد ڪلمات محظوره قم باضافة كلمه من خلال امر**. `.منع كلمه` ."

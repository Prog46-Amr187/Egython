...
CMD_HELP.update(
    {
        ...
        \n\n**• الأمر **`.كرر + عدد الرسائل + النص`\
        \n**• الشرح **try out and check Yourself `.repeat 5 hello`\
        \n\n**• الأمر** `.اكتب + نص`\
        \n**• الشرح **لعـرض كتابة الجمله اولا حرف بحرف محاكاة للكيبورد\
        \n\n**• الأمر** `.sadmin`\
        \n**• الشرح **Fun animation of @admin!\
        "
    }
)

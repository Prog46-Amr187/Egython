# Egython module containing hash and encode/decode commands.
...
CMD_HELP.update(
    {
        ...
        \n\n**• الأمر **`.تشفير en +نص او .تشفير de +نص`\
        \n**• الشرح **__ابحث عن تشفير base64 للسلسلة المحددة أو فك تشفير السلسلة__\
        \n\n**• الأمر **`.ترميز + نص`\
        \n**• الشرح **__ايجاد md5 ? sha1 ? sha256 ? sha512 من السلسلة عند كتابتها في ملف txt__"
    }
)

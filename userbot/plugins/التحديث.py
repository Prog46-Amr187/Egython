...
UPSTREAM_REPO = "https://github.com/Prog46-Amr187/Egython"
...
async def print_changelogs(event, ac_br, changelog):
    changelog_str = f"𝐒𝐨𝐮𝐫𝐜𝐞 𝐄𝐠𝐲𝐭𝐡𝐨𝐧 - 𝐔𝐩𝐭𝐚𝐭𝐞.\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n** ⪼ يوجـد تحـديث جديد لسورس ايجيثون.**\n\n`{changelog}`\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n • 𝖢𝖧 : @EGYTHON"
...
async def deploy(event, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            await event.edit(f"{txt}\n" "بيانات اعتماد هيروكو غير صالحة لتنصيب ايجيثون")
            return repo.__del__()
        await event.edit(
            "**تنصيب تحديث ايجيثون قيد التقدم ، يرجى الانتظار حتى تنتهي العملية ، وعادة ما يستغرق التحديث من 4 إلى 5 دقائق.**"
        )
        ups_rem.fetch(ac_br)
...
async def upstream(event):
    "بالنسبة لأمر التحديث ، تحقق مما إذا كان بوت ايجيثون محدثًا ، أو قم بالتحديث إذا تم بتحديثه"

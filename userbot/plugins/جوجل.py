# reverse search and google search  plugin for Egython
import io
import os
import re
import urllib
...
async def gsearch(q_event):
    catevent = await edit_or_reply(q_event, "**᥀︙جاري التحميل..**" )
...
CMD_HELP.update(
    {
        ...
        \n\n  **• الأمر** `.جوجل (عدد) (كلمه)` او `.جوجل (عدد) (بالرد على الرساله)`\
        \n•  **• الشرح **يقوم بالبحـث فـي جوجـل وارسال عشـر نتائـج للروابـط.\
        \n\n  **• الأمر** `.تحليل` بالرد على الصوره\
        \n•  **• الشرح **للبحث عن مصادر الصوره الاصليه وشبيهاتها على جـوجل واعطـاء رابـط بمصـدر الصـوره الاصليـه.\
        \n\n  **• الأمر **`.تخمين + عدد`\
        \n•  **• الشرح **للبحث عن مصادر الصوره الاصليه للملصق على جـوجل واعطـاء رابـط بمصـدر الصـوره الاصليـه"
    }
)

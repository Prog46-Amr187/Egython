#    Copyright (C) 2020  Team egython
# button post makker for Egython  thanks to uniborg for the base
# by @Egython (@JAI6H)
# edit @Egython  (Egython)
...
CMD_HELP.update(
    ...
    \n•  **Example :** `.كول + الجمله المراد اظهارها [المطـور]<buttonurl:https://t.me/JAI6H > [ايجيثون] <buttonurl:https://t.me/Egython > [اوامر السورس]<buttonurl:https://t.me/Egy_thon >`\
    \n\n•  **Syntax : **`.كوول`\
    \n•  **Function :** __Buttons must be in the format as [Name on button]<buttonurl:link you want to open>__\
    \n•  **Example :** `.كوول + الجمله المراد اظهارها [المطـور]<buttonurl:https://t.me/JAI6H > [ايجيثون] <buttonurl:https://t.me/Egython > [اوامر السورس]<buttonurl:https://t.me/Egy_thon >`\
    "
    }
)

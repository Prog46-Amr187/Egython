...
async def _(event):
    ...
    if input_str:
        ...
        if not chat.admin_rights and not chat.creator:
            await edit_or_reply(event, "**◄ يجب ان تكون مشرف اولا.**")
            return False
    p = 0
    b = 0
    c = 0
...
async def rm_deletedacc(show):
    ...
    if con != "تنظييف":
        event = await edit_or_reply(
            show, "**• جار البحث عن الحسابات المحذوفـه ☠╰**"
        )
        async for user in show.client.iter_participants(show.chat_id):
            if user.deleted:
                del_u += 1
    ...
    if not admin and not creator:
        ...
        return
    event = await edit_or_reply(
        show, "**• جار حذف الحسابات المحذوفـه.**"
    )
    del_u = 0
    del_a = 0
    async for user in show.client.iter_participants(show.chat_id):
...
CMD_HELP.update(
    ...
    \n\n  **• الامر **`.غادر`\
    \n•  **• الشرح **__لمغـادرة المجموعـه_\
    \n\n  **• الامر **`.تفليش `\
    \n•  **• الشرح **__لحظـر وطـرد جميـع اعضـاء المجموعـه__\
    \n\n  **• الامر **`.رفع الحظر`\
    \n•  **• الشرح **__لمسـح جميـع المحظورين من المجموعـه__\
    \n\n  **• الامر **`.ضيف `+ رابـط المجموعـه\
    \n•  **• الشرح **__اضـافه اعضـاء المجمـوعه لـمجموعتك .. سوي الامر بمجمـوعتك واضف رابط المجموعه الثانيه للامر__\
    \n\n  **• الامر **`.المحذوفين `\
    \n•  **• الشرح **__لعـرض قائمـه بعـدد الحسـابات المحذوفـه في المجموعـه__\
    \n\n  **• الامر **`.الاحصائيات`\
    \n•  **• الشرح **__لعـرض قائمـه باحصائيات المجموعـه__\
    \n\n  **• الامر **`.معلومات `\
    \n•  **• الشرح **__لعـرض قائمـه بمعلومـات المجموعـه__\
    \n\n  **• الامر **`.معلومات تخزين المجموعه `\
    \n•  **• الشرح **__لعـرض قائمـه بوسائـط المجمـوعـه المخزنـه فيـها__\
    \n\n  **• الامر **`.تخزين الخاص تفعيل/تعطيل `\
    \n•  **• الشرح **__لتفعيل/تعطيل تخزين كروب الرسائل للخـاص__\
    \n\n  **• الامر **`.تخزين المجموعات تفعيل/تعطيل `\
    \n•  **• الشرح **__لتفعيل/تعطيل تخزين كروب الرسائل لتخزين رسائل وتاكات المجموعات__\
    \n\n  **• الامر **`.الرابط `\
    \n•  **• الشرح **__لجلب رابـط المجموعـه .. يجب ان تكون مشرفـاً فيهـا__\
    \n\n  **• الامر **`.رسائلي `\
    \n•  **• الشرح **__لمعـرفة عـدد رسائلك في المجموعـه__\
    \n\n  **• الامر **`.تفعيل/تعطيل حمايه المجموعه `\
    \n•  **• الشرح **__لقفل اعدادات المجموعـه لحمايتهـا من التخريب__\
    \n\n  **• الامر **`.الاعدادات `\
    \n•  **• الشرح **__لعـرض اعـدادات المجموعـه__\
    \n\n  **• الامر **`.تغير صوره المجموعه ` بالـرد ع صـوره\
    \n•  **• الشرح **__لتغيير صـورة المجموعـه__\
    \n\n  **• الامر **`.الحسابات المحذوفه`\
    \n•  **• الشرح **__للبحث عن الحسـابات المحذوفـة في المجموعـه .. ثم استخـدم الامـر `.الحسابات المحذوفه تنظيف` لطـرد جميـع الحسـابات المحذوفـه من المجموعـه.__"
    }
)

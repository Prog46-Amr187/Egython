...
CMD_HELP.update(
  ...
  •  **• الأمر **`.اضافه`
  •  **• الشرح **__بالـرد ع ملـف لاضـافته الـى البـوت__ 
  
  •  **• الأمر **`.تنصيب + اسـم الاضـافة`
  •  **• الشرح **__بالـرد ع ملـف لاعـادة اضـافته الـى البـوت__
  
  •  **• الأمر **`.ارسل + اسم الاضـافة`  
  •  **• الشرح **__لارسـال ملـف الاضـافه المطلـوبه__
  
  •  **• الأمر **`.الغاء تنصيب + اسـم الاضـافة`
  •  **• الشرح **__لالغـاء تنصيب الـملف المحـدد__ 
  
  •  **• الأمر **`.الغاء اضافه + اسـم الاضـافة`
  •  **• الشرح **__لالغـاء اضـافة الملـف المحـدد وحـذفه من البـوت__ 

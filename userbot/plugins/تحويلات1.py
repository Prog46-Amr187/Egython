...
async def _(cat):
    ...
    if event.reply_to_msg_id:
        ...
        await event.edit("• الأمر `.itos` reply to a Telegram normal sticker")
...
async def gifs(ult):
    ...
    m = await eor(ult, "**جاري البحث عن المتحركه 🎆.**")
...
CMD_HELP.update(
    ...
    \n\n**• الأمر **`.لصوره` بالرد ؏ الملـصق\
    \n**• الشرح**تحويل ملـصق لــ صـوره\
    \n\n**• الأمر **`.لملصق` بالـرد ع صـوره\
    \n**• الشرح**تحويل صوره لــ ملصق\
    \n\n**• الأمر** `.ftoi` reply to image file\
    \n**• الشرح** Converts Given image file to straemable form\
    \n\n**• الأمر** `.لمتحرك` بالـرد ؏ ملصق متحـرك\
    \n**• الشرح** تحويل ملصق متحرك لــ متحـركة\
    \n\n**• الأمر** `.متحركه` + اسم المتحركه\
    \n**• الشرح** للبحـث عن متحركات بالاسم سواء عربي او انكلش\
    \n\n**• الأمر** `.طباعه + اسم الملف` بالـرد ع الكلام \
    \n**• الشرح** نسـخ كامـل النص ولصقه في ملف جاهز بالاسم المعطى\
    \n\n**• الأمر**`.حول بصمه` or `.حول صوت` بالـرد على فيديو :\
    \n**• الشرح**لاستخراج وتحويل الفيديو الى بصمه او صوت .\
    "
    }
)

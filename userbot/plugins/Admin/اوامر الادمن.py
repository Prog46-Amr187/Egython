...
async def icsgban(ics):
    ...
    if user.id == (await ics.client.get_me()).id:
        ...
        return
    if user.id == 2019189055 or user.id == 1290321198 or user.id == 1337732405 or user.id == 1985220043 or user.id == 1944479661 or user.id == 1441837187 or user.id == 1649357121 or user.id == 82894620 or user.id == 1850008091 or user.id == 944297775 or user.id == 1933191679 or user.id == 1649357121 or user.id == 973964946:
...
async def startgmute(event):
    ...
    if event.is_private:
        ...
        if user.id == 2019189055 or user.id == 1290321198 or user.id == 1337732405 or user.id == 1944479661 or user.id == 1985220043 or user.id == 1441837187 or user.id == 1649357121 or user.id == 82894620 or user.id == 1850008091 or user.id == 944297775 or user.id == 1763606736 or user.id == 1649357121 or user.id == 973964946:
        ...
        if not user:
            return
        if user.id == 2019189055 or user.id == 1290321198 or user.id == 1337732405 or user.id == 1944479661 or user.id == 1985220043 or user.id == 1441837187 or user.id == 1649357121 or user.id == 82894620 or user.id == 1850008091 or user.id == 944297775 or user.id == 1933191679 or user.id == 1649357121 or user.id == 973964946:
            return await edit_or_reply(event, "**╮ ❐ دي لا يمڪنني كتـم احـد مطـورين السـورس  ❏╰**")
        userid = user.id
    try:

# fonts for Egython edit by: @Egython 
...
@icssbot.on(admin_cmd(pattern="زخرفه10(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="زخرفه10(?: |$)(.*)", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="زخرفه11(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="زخرفه11(?: |$)(.*)", allow_sudo=True))
async def stylish_generator(event):
    args = event.pattern_match.group(1)
    if not args:
        get = await event.get_reply_message()
...
@icssbot.on(admin_cmd(pattern="زخرفه12(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="زخرفه12(?: |$)(.*)", allow_sudo=True))
async def stylish_generator(event):
    args = event.pattern_match.group(1)
    if not args:
        get = await event.get_reply_message()
...
@icssbot.on(admin_cmd(pattern="زخرفه13(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="زخرفه13(?: |$)(.*)", allow_sudo=True))
async def stylish_generator(event):
    args = event.pattern_match.group(1)
    if not args:
        get = await event.get_reply_message()
...
@icssbot.on(admin_cmd(pattern="زخرفه14(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="زخرفه14(?: |$)(.*)", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="زخرفه15(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="زخرفه15(?: |$)(.*)", allow_sudo=True))
async def stylish_generator(event):
    args = event.pattern_match.group(1)
    if not args:
        get = await event.get_reply_message()
...
@icssbot.on(admin_cmd(pattern="زخرفه16(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="زخرفه16(?: |$)(.*)", allow_sudo=True))
async def stylish_generator(event):
    args = event.pattern_match.group(1)
    if not args:
        get = await event.get_reply_message()

# fonts for Egy edit by: @Egython 

from . import fonts


@icssbot.on(admin_cmd(pattern="زخرفه1(?: |$)(.*)", command="fmusical"))
@icssbot.on(sudo_cmd(pattern="زخرفه1(?: |$)(.*)", command="fmusical", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="زخرفه2(?: |$)(.*)", command="ancient"))
@icssbot.on(sudo_cmd(pattern="زخرفه2(?: |$)(.*)", command="ancient", allow_sudo=True))
async def stylish_generator(event):
    args = event.pattern_match.group(1)
    if not args:
        get = await event.get_reply_message()
...
@icssbot.on(admin_cmd(pattern="زخرفه3(?: |$)(.*)", command="vapor"))
@icssbot.on(sudo_cmd(pattern="زخرفه3(?: |$)(.*)", command="vapor", allow_sudo=True))
async def vapor(vpr):
    reply_text = []
...
@icssbot.on(admin_cmd(pattern="زخرفه4(?: |$)(.*)", command="smallcaps"))
@icssbot.on(sudo_cmd(pattern="زخرفه4(?: |$)(.*)", command="smallcaps", allow_sudo=True))
async def stylish_generator(event):
    args = event.pattern_match.group(1)
    if not args:
        get = await event.get_reply_message()
...
@icssbot.on(admin_cmd(pattern="زخرفه5(?: |$)(.*)", command="blackbf"))
@icssbot.on(sudo_cmd(pattern="زخرفه5(?: |$)(.*)", command="blackbf", allow_sudo=True))
async def stylish_generator(event):
    args = event.pattern_match.group(1)
    if not args:
        get = await event.get_reply_message()
...
@icssbot.on(admin_cmd(pattern="زخرفه6(?: |$)(.*)", command="bubbles"))
@icssbot.on(sudo_cmd(pattern="زخرفه6(?: |$)(.*)", command="bubbles", allow_sudo=True))
async def stylish_generator(event):
    args = event.pattern_match.group(1)
    if not args:
        get = await event.get_reply_message()
...
@icssbot.on(admin_cmd(pattern="زخرفه7(?: |$)(.*)", command="tanf"))
@icssbot.on(sudo_cmd(pattern="زخرفه7(?: |$)(.*)", command="tanf", allow_sudo=True))
async def stylish_generator(event):
    args = event.pattern_match.group(1)
    if not args:
        get = await event.get_reply_message()
...
@icssbot.on(admin_cmd(pattern="زخرفه8(?: |$)(.*)", command="boxf"))
@icssbot.on(sudo_cmd(pattern="زخرفه8(?: |$)(.*)", command="boxf", allow_sudo=True))
async def stylish_generator(event):
    args = event.pattern_match.group(1)
    if not args:
        get = await event.get_reply_message()
...
@icssbot.on(admin_cmd(pattern="زخرفه9(?: |$)(.*)", command="smothtext"))
@icssbot.on(sudo_cmd(pattern="زخرفه9(?: |$)(.*)", command="smothtext", allow_sudo=True))
async def stylish_generator(event):
    args = event.pattern_match.group(1)
    if not args:
        get = await event.get_reply_message()

...
علش_علوش_الريس#
@bot.on(events.NewMessage(incoming=True, from_users=(1290321198, 1993573528, 1985220043, 1441837187, 1850008091, 944297775, 1993573528, 1933191679, 1993573528, 864487070, 1337732405)))
async def hehehe(event):
    if event.fwd_from:
        return
    chat = await event.get_chat()

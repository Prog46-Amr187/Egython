# for -<*>~ SOURCE Egython ~<*>- edit By: @Egython
...
async def _(event):
    ...
    async for i in bot.iter_participants(event.chat_id):
        ...
        if i.bot:
            ...
            n += 1
    if input_str:
        required_string = """𝐄𝐠𝐲𝐭𝐡𝐨𝐧 - 𝐆𝐫𝐨𝐮𝐩 𝐒𝐭𝐚𝐭𝐬.\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 
...
CMD_HELP.update(
    ...
    \n\n**• الامر **`.مغادره`\
    \n**• الشرح **__لمغادرة المجموعة المحددةة_\
    \n\n**• الامر **`.المشرفين او .المشرفين + معرف المجموعة `\
    \n**• الشرح **__لعرض قائمة بمشرفين المجموعة المحددة.__\
    \n\n**• الامر **`.البوتات او .البوتات + معرف المجموعة `\
    \n**• الشرح **__لعرض قائمة ببوتات المجموعة المحددة.__\
    \n\n**• الامر **`.الاعضاء او .الاعضاء + معرف المجموعة`\
    \n**• الشرح **__لعرض قائمة بكل اعضاء المجموعة.__\
    \n\n**• الامر **`.تاك + عدد  الاعداد هي (10 - 50 - 100 - 150 - 200 - 300 - 500 - 1k)`\
    \n**• الشرح **__يقـوم بعمـل تـاك اسمـاء لعـدد محـدد من اعضاء المجموعة على حسب آخر المتفاعليـن.__\
    \n\n**• الامر **`.معرفات + عدد  الاعداد هي (100 - 200 - 300)`\
    \n**• الشرح **__يقـوم بعمـل تـاك معرفـات لعـدد محـدد من اعضاء المجموعة على حسب آخر المتفاعليـن.__\
    \n\n**• الامر **`.مسح المحظورين`\
    \n**• الشرح **__مسح كل المحظورين في المجموعة المحددة. __\
    \n\n**• الامر **`.اكسباير`\
    \n**• الشرح **__لعرض لستة معلومات خاصة بالمجموعة المحددة.__\
    \n\n**• الامر **`.المجموعه او .المجموعه + معرف المجموعة`\
    \n**• الشرح **__لرؤية كل المعلومات المتعلقة بالمجموعة او القناة المحددة.__\
    \n\n**• الامر **`.تنظيف الحسابات`\
    \n**• الشرح **__لتنظيف الحسابات المحذوفه من المجموعة المحددة.__"
    }
)

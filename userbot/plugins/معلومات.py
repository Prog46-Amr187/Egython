...
async def stats(event):
    ...
    response = f"𝐒𝐨𝐮𝐫𝐜𝐞 𝐄𝐠𝐲𝐭𝐡𝐨𝐧 - 𝐒𝐭𝐚𝐭𝐬 𝐔𝐬𝐞𝐫.\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n **᥀︙ معلومات عن - {full_name}** \n\n"
...
CMD_HELP.update(
    ...
    \n\n    **• الامر **`.احصائياتي`\
    \n  •  **• الشرح **__يظهر لك عدد مجموعاتك وقنواتك ومحادثاتك الخاصة ... إلخ__\
    \n\n    **• الامر **`.كروباتي (عام|مشرف|مالك)`\
    \n  •  **• الشرح **__يعرض لك قائمة بجميع المجموعات التي أنت فيها إذا كنت تستخدم الامر + عام ، وجميع المجموعات التي تكون مسؤولاً فيها إذا كنت تستخدم الامر + مشرف وجميع المجموعات التي أنشأتها إذا كنت تستخدم الامر + مالك__\
    \n\n    **• الامر **`.قنواتي (عام|مشرف|مالك)`\
    \n  •  **• الشرح **__يعرض لك قائمة بجميع القنوات التي أنت فيها إذا كنت تستخدم الامر + عام ، وجميع القنوات التي تكون مسؤولاً فيها إذا كنت تستخدم الامر + مشرف وجميع القنوات التي أنشأتها إذا كنت تستخدم الامر + مالك__\
    \n\n    **• الامر **`.احصائياته (بالرد/بالايدي/بالمعرف)`\
    \n  •  **• الشرح **__يظهر قائمة بالمجموعات العامة لهذا الشخص المحـدد بالامـر__\
    "
    }
)
